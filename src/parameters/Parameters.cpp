...
long int max_nfeval = 50100; //50100; // maximum nfeval for experiments with maximum number of fitness evaluations
...
double *file_best_fitness_002, *file_best_fitness_020, *file_best_fitness_040;
