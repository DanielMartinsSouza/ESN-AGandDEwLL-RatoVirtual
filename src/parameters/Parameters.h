...
extern double *file_best_fitness_002, *file_best_fitness_020, *file_best_fitness_040; // data to be stored: best fitness at different times
...
extern int *vsort_aux;                                                                // data to be stored: number of fitness evaluations                                                    // auxiliar sorted vector of integers (used in different methods)
extern int save_datagen_flag;													      // flag for saving data for generation in the first run
extern int LL_flag;																      // linkage learning flag (0-without LinkageLearning; 1-with online LinkageLearning; 2-with offline LinkageLearning)
